...
def add_model_comparison():
    ...
    # Define metrics for each model (using your actual values)
    metrics = {
        'XGBoost': {
            'MAE': 190.14,  # Replace with your actual MAE
            'RMSE': 263.89, # Replace with your actual RMSE
            'R2': 0.7408    # Replace with your actual R2
        },
        'Random Forest': {
            'MAE': 270.60,  # Replace with your actual MAE
            'RMSE': 182.54, # Replace with your actual RMSE
            'R2': 0.7275     # Replace with your actual R2
        },
        'Linear Regression': {
            'MAE': 288.87,  # Replace with your actual MAE
            'RMSE': 374.4, # Replace with your actual RMSE
